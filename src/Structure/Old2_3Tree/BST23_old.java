...
public class BST23_old<T extends  Comparable<T>, V> {

    private BST23Node_old<T,V> _root;
    ...
    public boolean delete(BST23Node_old pNode){
        BST23Node_old deletedNode = find(pNode);
        if (deletedNode != null){
            ...
            BST23Node_old alterNode = findInOrderNode(deletedNode, pNode);
            ...
            while (alterNode != null){
                ...
                BST23Node_old brotherNode = findBrother(alterNode);
    ...
    public BST23Node_old findBrother(BST23Node_old node){
    ...
    public BST23Node_old findInOrderNode(BST23Node_old node, BST23Node_old nodeData){
        if (isLeaf(node)){
            return node;
        }
        if (nodeData.get_data1().compareTo(node.get_data1()) == 0){
            //data ktore mazem su nalavo
            BST23Node_old temp = node.get_right1();
            while (!isLeaf(temp)){
                temp = temp.get_left1();
            }
            return temp;
            ...
            BST23Node_old temp = node.get_right2();
            while (!isLeaf(temp)){
                temp = temp.get_left1();
            }
            return temp;
    ...
    public boolean isLeaf(BST23Node_old node){
    ...
    public boolean insert(BST23Node_old pNode){
        if (_root == null){
            _root = pNode;
            return true;
        }else if(find(pNode) == null) {
            BST23Node_old leaf = findLeafForInsert(pNode);
            if (leaf != null){
                if (!leaf.isThreeNode()){
                    ...
                    while (leaf != null){
                        ...
                        if (leaf == _root){
                            //ked je node korenom
                            BST23Node_old newRoot = new BST23Node_old(middle, middleValue);
                            BST23Node_old newRightSon = new BST23Node_old(max, maxValue);
                            ...
                            if (!leaf.get_parent().isThreeNode()){
                                ...
                                if (leaf.get_parent().get_left1() == leaf){
                                    ...
                                    BST23Node_old newNode = new BST23Node_old(max, maxValue);
                                    ...
                                    //ak je pravy potomok
                                    BST23Node_old newNode = new BST23Node_old(min, minValue);
                                    newNode.set_parent(leaf.get_parent());
    ...
    private boolean areNodesEqual(BST23Node_old node1, BST23Node_old node2){
    ...
    private T getMin(BST23Node_old threeNode, BST23Node_old addedNode){
        T min;
    ...
    private V getMinValue(BST23Node_old threeNode, BST23Node_old addedNode){
        T minKey;
        V min;
        if (threeNode.get_data1().compareTo(threeNode.get_data2()) > 0){
            //overit spravnost pretypovania
    ...
    private T getMax(BST23Node_old threeNode, BST23Node_old addedNode){
        T max;
        if (threeNode.get_data1().compareTo(threeNode.get_data2()) < 0){
            //overit spravnost pretypovania
    ...
    private V getMaxValue(BST23Node_old threeNode, BST23Node_old addedNode){
        V max;
        T maxKey;
        if (threeNode.get_data1().compareTo(threeNode.get_data2()) < 0){
            //overit spravnost pretypovania
    ...
    private T getMiddle(BST23Node_old threeNode, BST23Node_old addedNode){
        T smaller;
        T bigger;
        if (threeNode.get_data1().compareTo(threeNode.get_data2()) > 0){
            //overit spravnost pretypovania
    ...
    private V getMiddleValue(BST23Node_old threeNode, BST23Node_old addedNode){
        V smaller;
        T smallerKey;
        V bigger;
        T biggerKey;
    ...
    private BST23Node_old findLeafForInsert(BST23Node_old pNode){
        if (_root != null){
            ...
            if (_root.get_left1() == null &&
                ...
                BST23Node_old prev = null;
                BST23Node_old temp = _root;
                while (temp != null){
    ...
    public BST23Node_old find(BST23Node_old pNode){
    ...
    public ArrayList<BST23Node_old> intervalSearch(BST23Node_old minNode, BST23Node_old maxNode){
        ArrayList<BST23Node_old> listOfFoundNodes = new ArrayList<>();
        BST23Node_old prev = null;
        T prevKey = null;
        BST23Node_old temp = _root;
        if (temp == null){
        ...
        if (belongsToInterval(minNode, maxNode, prevKey)){
            ...
            if (prev.get_data1().compareTo(prevKey) == 0){
                BST23Node_old newNode = new BST23Node_old(prev.get_data1(), prev.get_value1());
                listOfFoundNodes.add(newNode);
            }else {
                BST23Node_old newNode = new BST23Node_old(prev.get_data2(), prev.get_value2());
                listOfFoundNodes.add(newNode);
            }

        }
        NodeAndKey_old inOrderNode = findInOrderIntervalSearch(prev, prevKey);
            ...
            if (belongsToInterval(minNode, maxNode, (T) inOrderNode.getKey())){
                if (inOrderNode.getNode().isThreeNode()){
                    if (inOrderNode.getNode().get_data1().compareTo((T) inOrderNode.getKey()) == 0){
                        //prve data
                        BST23Node_old newNode =
                                new BST23Node_old(inOrderNode.getNode().get_data1(), inOrderNode.getNode().get_value1());
                        listOfFoundNodes.add(newNode);
                        ...
                        //druhe data
                        BST23Node_old newNode =
                                new BST23Node_old(inOrderNode.getNode().get_data2(), inOrderNode.getNode().get_value2());
                        listOfFoundNodes.add(newNode);
                        inOrderNode = findInOrderIntervalSearch(
                                inOrderNode.getNode(),
    ...
    private NodeAndKey_old findInOrderIntervalSearch(BST23Node_old node, T key){
        if (!node.isThreeNode()){
            if (node.get_right1() != null){
                ...
                NodeAndKey_old nodeAndKey = new NodeAndKey_old(temp, temp.get_data1());
                return nodeAndKey;
            }else {
                //nema syna tak pojde po parentoch
                BST23Node_old temp = node;
                while (temp != null){
                    if (temp.get_parent() != null){
                        if (temp.get_parent().isThreeNode()){
                            if (key.compareTo((T) temp.get_parent().get_data1()) > 0){
                                NodeAndKey_old nodeAndKey = new NodeAndKey_old(temp.get_parent(), temp.get_parent().get_data1());
                                return nodeAndKey;
                            }
                            if ((key.compareTo((T) temp.get_parent().get_data1()) < 0) &&
                                    (key.compareTo((T) temp.get_parent().get_data2()) > 0)){
                                NodeAndKey_old nodeAndKey = new NodeAndKey_old(temp.get_parent(), temp.get_parent().get_data2());
                                return nodeAndKey;
                            }
                        }else {
                            if (key.compareTo((T) temp.get_parent().get_data1()) > 0){
                        ...
                        if (!temp.isThreeNode()){
                            ...
                            if (key.compareTo((T) temp.get_data1()) > 0){
                                ...
                                NodeAndKey_old nodeAndKey = new NodeAndKey_old(temp, temp.get_data2());
                                return nodeAndKey;
                            }else {
                                return null;
                            }
            ...
            if (key.compareTo((T) node.get_data1()) == 0){
                if (node.get_right1() == null){
                    ...
                    NodeAndKey_old nodeAndKey = new NodeAndKey_old(node, node.get_data2());
                    return nodeAndKey;
                }else {
    ...
    public ArrayList<BST23Node_old> inOrder(){
        ArrayList<BST23Node_old> listOfFoundNodes = new ArrayList<>();
        BST23Node_old temp = _root;
        if (_root == null){
            return listOfFoundNodes;
        ...
        BST23Node_old newNode = new BST23Node_old(temp.get_data1(), temp.get_value1());
        listOfFoundNodes.add(newNode);
        //pouziviame hladanie in order nasledovnika z intervaloveho hladania
        NodeAndKey_old inOrderNode = findInOrderIntervalSearch(temp, (T) temp.get_data1());
        while (inOrderNode != null){
            if (inOrderNode.getNode().isThreeNode()){
                if (inOrderNode.getNode().get_data1().compareTo((T) inOrderNode.getKey()) == 0){
                    //prve data
                    BST23Node_old new_Node =
                            new BST23Node_old(inOrderNode.getNode().get_data1(), inOrderNode.getNode().get_value1());
    ...
    public NodeWithKey_old getFirst(){
        BST23Node_old temp = _root;
        if (_root == null){
            return null;
        }
        ...
        return new NodeWithKey_old(temp, temp.get_data1());
    }

    public NodeWithKey_old getNext(BST23Node_old pNode, T key){
        NodeAndKey_old temp = findInOrderIntervalSearch(pNode, key);
        if (temp == null){
            return null;
        }else {
            NodeWithKey_old nodeWithKey = new NodeWithKey_old(temp.getNode(),temp.getKey());
            return nodeWithKey;
        }
    }

    private boolean belongsToInterval(BST23Node_old minNode, BST23Node_old maxNode, T key){
    ...
    public BST23Node_old<T,V> get_root() {
        return _root;
    }
}

class NodeAndKey_old<T extends  Comparable<T>, V>{
    private BST23Node_old<T,V> node;
    private T key;

    public NodeAndKey_old(BST23Node_old pNode, T pKey){
        node = pNode;
        key = pKey;
    }
